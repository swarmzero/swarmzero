    ...
    def run(self):
        ...
        for task_with_priority in sorted_tasks:
            try:
                ...
                logging.info(f"Task {task_with_priority.task_id} with priority {task_with_priority.priority} completed successfully.")
            except Exception as e:
                logging.error(f"Error executing task {task_with_priority.task_id} with priority {task_with_priority.priority}: {e}")
