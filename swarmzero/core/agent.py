...
from swarmzero.api.models import ToolInstallRequest
from swarmzero.api.routes import files, setup_routes
from swarmzero.api.routes.files import insert_files_to_index
...
from swarmzero.core.services.llms.utils import llm_from_config
from swarmzero.core.services.retriever.base_retrieve import (
    IndexStore,
    RetrieverBase,
    index_base_dir,
    supported_exts,
...
class Agent:
    ...
    async def cleanup(self):
        ...
        if self.sdk_context:
            await self.sdk_context.cleanup()
